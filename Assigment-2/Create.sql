...
Verify Enums (CHECK)
Verify 1 to 1..* table
Verify Inheritance (CHECK)
Verify Phone and Address (check)

NOTES TO SELF:
NOT NULL means 1 to many
NULL mean 0 to many:
foreign key([fieldname to hold primary key of other table]) references [tablename](field)
CONSTRAINT allows you to categorize your data 
*/
/*
...
FOREIGN KEY(website_id) REFERENCES website(website_id) #1 to 1..*
         on DELETE CASCADE#ADD THESE FOR ROLE AND PAGE ROLE AND PRIVILEGE 
);
